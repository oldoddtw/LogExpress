...
1. Apply for a registration code.
    +  Please send an email to [Register](mailto:service@logexpress.tw) to apply for a registration code. Please indicate the following information in the letter:
      > * Your country
      > * Your full name
